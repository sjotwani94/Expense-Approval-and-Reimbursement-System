                ...
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        <h3 class="animated fadeInLeft">Institute of Technology, Nirma University</h3>
                        <p class="animated fadeInDown"><span class="fa  fa-map-marker"></span> Ahmedabad,Gujarat,India</p>
						</div>
                    <div class="col-md-6 col-sm-12">
                        <div class="col-md-6 col-sm-6 text-right" style="padding-left:10px;">
                          <h3 style="color:#DDDDDE;"><span class="fa  fa-map-marker"></span> Chharodi</h3>
                        ...
                        <div class="col-md-8 padding-0">
                            ...
                            <div class="col-md-12">
                                <div class="panel box-v4">
                                    <div class="panel-heading bg-white border-none">
									<?php 
										$sql="select count(*) as record from expense_form_1 where Emp_Name='$login_session'";
										$result=mysqli_query($conn,$sql);
										$row=mysqli_fetch_array($result);
										?>
                                      <h4><span class="icon-notebook icons"></span> Applications : <?php echo $row['record'];?></h4>
                                    </div>
                                  ...
                                  <div class="panel-body">
                                    <div class="col-md-12 padding-0 text-center">
                                      <div class="col-md-4 col-sm-4 col-xs-6 padding-0">
										<?php 
										$sql="select count(*) as record from expense_form_1 where Emp_Name='$login_session' and Dean_Approved='Approve'";
										$result=mysqli_query($conn,$sql);
										$row=mysqli_fetch_array($result);
										?>
                                          <h3><?php echo $row['record'];?></h3>
                                          <p>Approved</p>
                                      </div>
                                      <div class="col-md-4 col-sm-4 col-xs-6 padding-0">
										<?php 
										$sql="select count(*) as record from expense_form_1 where Emp_Name='$login_session' and Dean_Approved='' ";
										$result=mysqli_query($conn,$sql);
										$row=mysqli_fetch_array($result);
										?>
                                          <h3><?php echo $row['record'];?></h3>
                                      ...
                                      <div class="col-md-4 col-sm-4 col-xs-12 padding-0">
										<?php 
										$sql="select count(*) as record from expense_form_1 where Emp_Name='$login_session' and Dean_Approved='Reject' ";
										$result=mysqli_query($conn,$sql);
										$row=mysqli_fetch_array($result);
										?>
                                          <h3><?php echo $row['record'];?></h3>
