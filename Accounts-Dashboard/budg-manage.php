                            ...
                            <div class="col-md-12 m-b-30">
                                ...
                                <div class="d-block d-sm-flex flex-nowrap align-items-center">
                                    <div class="page-title mb-2 mb-sm-0">
                                        <h1>Budgets Allocation to <?php echo $_GET['Department']; ?> Department</h1>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="datatable-wrapper table-responsive">
                                            <table id="datatable" class="display compact table table-bordered">
												...
												$sql="select * from budgets where Department='$Dept'";
												...
												?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $Budget_Allocated; ?></td>
                                                        <td><?php echo $Budget_Utilized; ?></td>
														<td><?php echo $Budget_Available; ?></td>
														<td style="white-space: nowrap; width: 1%;">
															
																<div class="btn-group btn-group-sm">
																	<button type="button" onclick="window.location.href = 'updatedata.php?Action=Update&&Section=<?php echo $section; ?>';" class="tabledit-edit-button btn btn-sm btn-primary">
														...
														<td style="white-space: nowrap; width: 1%;">
																...
																<div class="btn-group btn-group-sm">
																	<button type="button" onclick="window.location.href = 'deletedata.php?Section=<?php echo $section; ?>';" class="tabledit-edit-button btn btn-sm btn-primary">
