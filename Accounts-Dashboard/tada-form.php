                                    ...
                                    <div class="card-body">
                                        <div class="datatable-wrapper table-responsive">
                                            <table id="datatable" class="display compact table table-bordered">
												...
												<?php
												$id=0;
												$sql="select * from ta_da_1";
												$result = mysqli_query($conn,$sql);				
												while($row = mysqli_fetch_array($result))
												{
												$tid=$row["ID"];
												$Email_ID=$row["EMAIL_ID"];
												$enddate=$row["ALL_MONTH"];
												...
												?>
                                                    <tr>
														<td><a href="form-data-tada.php?Email_ID=<?php echo $Email_ID; ?>&&ID=<?php echo $tid; ?>"><?php echo $id; ?></a></td>
                                                        <td><a href="form-data-tada.php?Email_ID=<?php echo $Email_ID; ?>&&ID=<?php echo $tid; ?>"><?php echo $EName; ?></a></td>
                                                        <td><a href="form-data-tada.php?Email_ID=<?php echo $Email_ID; ?>&&ID=<?php echo $tid; ?>"><?php echo $Email_ID; ?></a></td>
                                                        <td><a href="form-data-tada.php?Email_ID=<?php echo $Email_ID; ?>&&ID=<?php echo $tid; ?>"><?php echo $Purpose; ?></a></td>
														<td><a href="form-data-tada.php?Email_ID=<?php echo $Email_ID; ?>&&ID=<?php echo $tid; ?>"><?php echo $EDate; ?></a></td>
