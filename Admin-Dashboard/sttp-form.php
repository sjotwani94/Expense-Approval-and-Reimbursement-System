                                    ...
                                    <div class="card-body">
                                        <div class="datatable-wrapper table-responsive">
                                            <table id="datatable" class="display compact table table-bordered">
												...
												$sql="select * from expense_form_1 where Event_Type='$Event_Type'";
												...
												?>
                                                    <tr>
														<td><a href="form-data-sttp.php?EName=<?php echo $name; ?>&&ID=<?php echo $tid; ?>"><?php echo $id; ?></a></td>
                                                        <td><a href="form-data-sttp.php?EName=<?php echo $name; ?>&&ID=<?php echo $tid; ?>"><?php echo $name; ?></a></td>
                                                        <td><a href="form-data-sttp.php?EName=<?php echo $name; ?>&&ID=<?php echo $tid; ?>"><?php echo $designation; ?></a></td>
                                                        <td><a href="form-data-sttp.php?EName=<?php echo $name; ?>&&ID=<?php echo $tid; ?>"><?php echo $eventtype; ?></a></td>
														<td><a href="form-data-sttp.php?EName=<?php echo $name; ?>&&ID=<?php echo $tid; ?>"><?php echo $PresentationPaper; ?></a></td>
														<td><a href="form-data-sttp.php?EName=<?php echo $name; ?>&&ID=<?php echo $tid; ?>"><?php echo $Eventplaced; ?></a></td>
														<td style="white-space: nowrap; width: 1%;">
															
																<div class="btn-group btn-group-sm">
																	<button type="button" onclick="window.location.href = 'updatesttp.php?ID=<?php echo $tid; ?>';" class="tabledit-edit-button btn btn-sm btn-primary">
